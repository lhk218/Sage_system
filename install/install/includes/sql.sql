/**
* Custom SQL statements added to create Sage tables, add custom pages and roles to UserSpice user management.
*
* Framework used:
* UserSpice 5
...
/* STAFF VIEW */
(98, 'main', -1, 0, 1, 9, 'Home', 'index.php', 'fa fa-fw fa-home'),
(99, 'main', -1, 0, 1, 10, 'Shift Preferences', 'staff/shift_preferences.php', 'fa fa-fw fa-check-square-o'),
(100, 'main', -1, 0, 1, 10, 'Shift Swaps', 'staff/shift_swaps.php', 'fa fa-fw fa-refresh'),
(102, 'main', -1, 0, 1, 10, 'Shift Notes', 'work_log.php', 'fa fa-fw fa-sticky-note'),
/* MANAGER VIEW */
(94, 'main', -1, 0, 1, 9, 'Home', 'index.php', 'fa fa-fw fa-home'),
(95, 'main', -1, 0, 1, 10, 'Shift Swaps', 'managers/shift_swaps.php', 'fa fa-fw fa-refresh'),
(103, 'main', -1, 0, 1, 10, 'Shift Notes', 'work_log.php', 'fa fa-fw fa-sticky-note'),
(96, 'main', -1, 0, 1, 10, 'Users', 'managers/staff_list.php', 'fa fa-fw fa-users');
-- --------------------------------------------------------
...
(95, 'managers/shift_swaps.php', 'Shift Management - Swaps', 1, 0),
(96, 'managers/staff_list.php', 'Shift Management - Users', 1, 0),
(97, 'managers/shift_view.php', 'Shift Management - Shift Overview', 1, 0),
(99, 'staff/shift_preferences.php', 'Staff Area - Shift Preferences', 1, 0),
(100, 'staff/shift_swaps.php', 'Staff Area - Shift Swaps', 1, 0),
(101, 'staff/shift_view.php', 'Staff Area - Shift Overview', 1, 0),
(102, 'work_log.php', 'Shift Notes', 1, 0),
(103, 'usersc/account.php', 'Account Dashboard', 1, 0),
(104, 'usersc/user_settings.php', 'User Settings', 1, 0),
(105, 'usersc/forgot_password.php', 'Forgotten Password', 0, 0),
(106, 'usersc/forgot_password_reset.php', 'Forgotten Password Reset', 0, 0);
...
(1, 0, 0, 0, '../users/css/color_schemes/bootstrap.min.css', '../users/css/sb-admin.css', '../users/css/custom.css', 'Sage Live Services', 'en', 1, 0, 0, 0, 0, '', '', '', '', '', '', '', '', '', 0, 0, 6, 30, 4, 30, 1, 1, 0, 1, 0, '/', 'everything', '', 0, 0, 0, 0, 0, 1, 0, 7, '6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI', '6LeIxAcTAAAAAGG-vFI1TnRWxMZNFuojJ4WifJWe', 1, 1, 'Team 5', 1, '', 0, 0, 'off', 0, 24, 15, 1, 120, 0, 'standard', NULL, NULL, 1);
...
--
-- SAGE CUSTOM STATEMENTS
--

CREATE TABLE `sage_shifts` (
  `id` int(11) NOT NULL,
  `user_id` int(11),
...
ALTER TABLE `sage_work_log`
  ADD PRIMARY KEY (`id`),
  ADD FOREIGN KEY (`user_id`) REFERENCES users (`id`)
      ON DELETE SET NULL
      ON UPDATE CASCADE;

ALTER TABLE `sage_preferences`
  ADD PRIMARY KEY (`id`),
  ADD FOREIGN KEY (`user_id`) REFERENCES users (`id`)
      ON DELETE CASCADE
      ON UPDATE CASCADE;

ALTER TABLE `sage_shift_swaps`
  ADD PRIMARY KEY (`id`),
  ADD FOREIGN KEY (`requester_id`) REFERENCES users (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

ALTER TABLE `sage_shift_swaps`
  ADD FOREIGN KEY (`respondent_id`) REFERENCES users (`id`) ON DELETE SET NULL ON UPDATE CASCADE;

ALTER TABLE `sage_shift_swaps`
  ADD FOREIGN KEY (`shift_id`) REFERENCES sage_shifts (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
